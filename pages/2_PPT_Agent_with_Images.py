...
GROQ_API_KEY = os.getenv("GROQ_API_KEY_2") or st.secrets.get("GROQ_API_KEY_2", "")
...
# --- UI ---
st.title("🖼️ Research Paper to PPT (with Images)")
st.caption("Upload a `.zip` or `.tar.gz` archive containing your full LaTeX project (must include `main.tex`).")
